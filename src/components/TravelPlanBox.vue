              ...
              <el-collapse v-model="activeDetails">
                ...
                >
                  <div class="detail-content">
                    ...
                    <p v-if="detail.coordinates"><span class="label">前往地图导航:</span> <a :href="`https://uri.amap.com/marker?position=${detail.coordinates}`" title="跳转到高德地图" target="_blank"><el-icon><Position /></el-icon></a></p>
